...
\position{Engineer{\enskip\cdotp\enskip}Access and Security} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Christoph Biesinger Lebenslauf}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/interessen.tex}
